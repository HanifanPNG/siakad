                    ...
                    <div class="row">
                     ...
                     <?php
                      if($_POST['simpan']){
                        ...
                        $sql="insert into mahasiswa set NIM='$nim', nama='$nama', gender='$jk', alamat='$alamat', prodi='$prodi', waktu='$waktu'";
                        $a=$db->query($sql);
                        if($a){
                      ...
                      <form action="#" method="post">
                        <table>
                          ...
                          <tr><td valign="top">Alamat</td><td><textarea name="alamat" class="form-control" style="width: 200px;"><?=$alamat?></textarea></td></tr>
                          ...
                          <tr><td></td><td><button type="submit" name="simpan" value="Simpan" class="btn btn-primary mt-2">Simpan</button></td></tr>
                        </table>
                      </form>
